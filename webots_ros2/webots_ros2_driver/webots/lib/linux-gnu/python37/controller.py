...
class Altimeter(Device):
    ...
    for _s in [Device]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, Altimeter, name, value)
    __swig_getmethods__ = {}
    for _s in [Device]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, Altimeter, name)
    __repr__ = _swig_repr

    def __init__(self, name):
        this = _controller.new_Altimeter(name)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
Altimeter_swigregister = _controller.Altimeter_swigregister
Altimeter_swigregister(Altimeter)
...
class ContactPoint(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ContactPoint, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ContactPoint, name)
    __repr__ = _swig_repr
    __swig_setmethods__["point"] = _controller.ContactPoint_point_set
    __swig_getmethods__["point"] = _controller.ContactPoint_point_get
    if _newclass:
        point = _swig_property(_controller.ContactPoint_point_get, _controller.ContactPoint_point_set)
    __swig_setmethods__["node_id"] = _controller.ContactPoint_node_id_set
    __swig_getmethods__["node_id"] = _controller.ContactPoint_node_id_get
    if _newclass:
        node_id = _swig_property(_controller.ContactPoint_node_id_get, _controller.ContactPoint_node_id_set)
    ...
    def __init__(self):
        this = _controller.new_ContactPoint()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
ContactPoint_swigregister = _controller.ContactPoint_swigregister
ContactPoint_swigregister(ContactPoint)
